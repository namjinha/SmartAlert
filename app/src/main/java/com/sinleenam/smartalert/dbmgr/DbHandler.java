package com.sinleenam.smartalert.dbmgr;

import android.content.Context;
import android.database.Cursor;

import com.sinleenam.smartalert.data.KeywordData;
import com.sinleenam.smartalert.data.NotiData;
import com.sinleenam.smartalert.data.PackData;
	...
	public int selectCountDB(int aSelectType, String aParam)
	{
		...
		switch(aSelectType)
		{
			...
			case DBValue.TYPE_SELECT_DISLIKE_PACKAGE_COUNT:
				...
				break;
			case DBValue.TYPE_SELECT_LIKE_PACKAGE_COUNT:
				cursor = mDbManager.query(DBValue.SQL_SELECT_LIKE_PACKAGE_COUNT, null);
				if(null == cursor)
				{
					return count;
				}
